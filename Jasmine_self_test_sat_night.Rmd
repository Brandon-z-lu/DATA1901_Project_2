...
l_merrylands_dist <- read.csv("l_files/l_merrylands_houseprice.csv")
l_eastwood_dist <- read.csv("l_files/l_eastwood_houseprice.csv")
l_auburn_dist <- read.csv("l_files/l_auburn_houseprice.csv")
l_granville_dist <- read.csv("l_files/l_granville_houseprice.csv")
