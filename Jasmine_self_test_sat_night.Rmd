---
title: "Data from Computer Version: Jasmine_sat_night"
...
```{r}
l_parramatta_dist <- read.csv("~/Uni-Code/4_DATA1901_RStudio/Project2/l_files/l_parramatta_houseprice.csv")
l_merrylands_dist <- read.csv("~/Uni-Code/4_DATA1901_RStudio/Project2/l_files/l_merrylands_houseprice.csv")
l_eastwood_dist <- read.csv("~/Uni-Code/4_DATA1901_RStudio/Project2/l_files/l_eastwood_houseprice.csv")
l_auburn_dist <- read.csv("~/Uni-Code/4_DATA1901_RStudio/Project2/l_files/l_auburn_houseprice.csv")
l_granville_dist <- read.csv("~/Uni-Code/4_DATA1901_RStudio/Project2/l_files/l_granville_houseprice.csv")
