...
get_df_suburb <- function(location = "2151/Parramatta/"){
  ...
  return(df)
    ...
    file_path <- "main1_export_log/"
    file_name <- "main1_export_log.txt"
...
clear_log <- function() {
  # Set the file path and name
  file_path <- "main_before_graph_export_log/"
  file_name <- "main_before_graph_export_log.txt"
...
## Export all
```{r}
export_all_suburbs("suburbs_main_export_Brandon_Lu.txt")
```
