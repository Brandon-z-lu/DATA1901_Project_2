...
```{r}
l_parramatta_dist <- read.csv("~/Desktop/UNI/1st Year/DATA1901 files/Project/Project 2/Long Lat Suburb Data/l_parramatta_houseprice.csv")
l_merrylands_dist <- read.csv("~/Desktop/UNI/1st Year/DATA1901 files/Project/Project 2/Long Lat Suburb Data/l_merrylands_houseprice.csv")
l_eastwood_dist <- read.csv("~/Desktop/UNI/1st Year/DATA1901 files/Project/Project 2/Long Lat Suburb Data/l_eastwood_houseprice.csv")
l_auburn_dist <- read.csv("~/Desktop/UNI/1st Year/DATA1901 files/Project/Project 2/Long Lat Suburb Data/l_auburn_houseprice.csv")
l_granville_dist <- read.csv("~/Desktop/UNI/1st Year/DATA1901 files/Project/Project 2/Long Lat Suburb Data/l_granville_houseprice.csv")
...
l_parramatta_dist <- l_parramatta_dist[, -1] # this is the code for removing that extra row of index 
