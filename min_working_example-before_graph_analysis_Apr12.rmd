...
get_df_suburb <- function(location = "2151/Parramatta/"){
  ...
  print(paste0(location, ": begins 0/5"))
...
get_l_suburb <- function(df_suburb, suburb_lat, suburb_lon, location) {
...
get_l_suburb_dist <- function(l_suburb, suburb_lat, suburb_lon)   {
...
export_a_suburb <- function(location, suburb_lat, suburb_lon) {
  ...
  l_subrub <- get_l_suburb(df_suburb, suburb_lat, suburb_lon, location)
  l_suburb_dist <- get_l_suburb_dist(l_suburb, suburb_lat, suburb_lon)
