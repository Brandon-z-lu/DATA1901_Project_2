...
get_l_suburb <- function(df_suburb, location) {
...
get_l_suburb_dist <- function(l_suburb, suburb_lat, suburb_lon, location) {
  # print(l_suburb) ###
...
export_a_suburb <- function(location, suburb_lat, suburb_lon) {
  ...
  l_subrub <- get_l_suburb(df_suburb, location)
  l_suburb_dist <- get_l_suburb_dist(l_suburb, suburb_lat, suburb_lon, location)
